...
export function createHttpApi({ baseUrl }: HttpApiOptions): AppApi {
  ...
  return {
    ...
    updateBranding: (input: Partial<Branding>) =>
      request<Partner>(apiRoutes.partnerBranding, {
        method: "PATCH",
        body: JSON.stringify(input),
      }),
    verifyCustomDomain: (domain: string) =>
      request<any>(apiRoutes.partnerVerifyDomain, {
        method: "POST",
        body: JSON.stringify({ domain }),
      }),
    getPartnerSubWorkspaces: () =>
      request<any[]>(apiRoutes.partnerSubWorkspaces, {
        method: "GET",
      }),
    createPartnerSubWorkspace: (input: any) =>
      request<any>(apiRoutes.partnerSubWorkspaces, {
        method: "POST",
        body: JSON.stringify(input),
      }),
    topupPartnerSubWorkspace: (subWorkspaceId: string, input: any) =>
      request<any>(`${apiRoutes.partnerSubWorkspaces}/${subWorkspaceId}/topup`, {
        method: "POST",
        body: JSON.stringify(input),
      }),
    getPartnerCommissions: () =>
      request<any[]>(apiRoutes.partnerCommissions, {
        method: "GET",
      }),
    getCurrentBranding: () =>
      request<Branding>(apiRoutes.brandingCurrent, {
        method: "GET",
      }),
    getUsers: () =>
