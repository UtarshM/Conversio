      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <h4 className="text-xs font-bold uppercase tracking-widest text-emerald-400 font-mono border-b border-emerald-500/30 pb-1 inline-block">Platform Solutions</h4>
              <ul className="space-y-2 text-xs text-slate-400 font-medium">
                <li><Link to="/d2c-retention" className="hover:text-emerald-400 transition-colors">Conversio D2C Retention</Link></li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-400 font-medium">
              <li><Link to="/d2c-retention" className="hover:text-white transition-colors">Abandoned Cart Recovery</Link></li>
              <li><Link to="/d2c-retention" className="hover:text-white transition-colors">COD Orders to Prepaid</Link></li>
              <li><Link to="/tri-channel-sales" className="hover:text-white transition-colors">Tri-Channel Cadences</Link></li>
              <li><Link to="/tri-channel-sales" className="hover:text-white transition-colors">Stop-on-Reply Automation</Link></li>
              <li><Link to="/home#features" className="hover:text-white transition-colors">WhatsApp Order Alerts</Link></li>
              <li><Link to="/home#features" className="hover:text-white transition-colors">Repeat Orders &amp; Upsell</Link></li>
              <li><Link to="/playground" className="hover:text-white transition-colors">Support &amp; Sales Chatbot</Link></li>
            </ul>
          </div>

          {/* COLUMN 4: Support & Use Cases */}
          <div className="space-y-6">
            <div className="space-y-3">
            ...
            <div className="space-y-3 pt-2">
              <h4 className="text-xs font-bold uppercase tracking-widest text-emerald-400 font-mono border-b border-emerald-500/30 pb-1 inline-block">Use Cases</h4>
              <ul className="space-y-2 text-xs text-slate-400 font-medium">
                <li><Link to="/d2c-retention" className="hover:text-white transition-colors">Cart Recovery Playbook</Link></li>
                <li><Link to="/d2c-retention" className="hover:text-white transition-colors">COD Fraud &amp; RTO Shield</Link></li>
                <li><Link to="/tri-channel-sales" className="hover:text-white transition-colors">Speed-to-Lead Dialing</Link></li>
                <li><Link to="/tri-channel-sales" className="hover:text-white transition-colors">Stop-on-Reply Workflows</Link></li>
              </ul>
            </div>
          </div>
