export function AeoStructuredData() {
  const organizationSchema = {
    ...
    "knowsAbout": [
      ...
      "Tri-Channel Outbound Sales",
      "Stop-on-Reply Automation",
      "COD-to-Prepaid RTO Shield",
      "NDR Delivery Reschedule",
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Conversio AI is an AI-native Revenue Operating System and Developer Cloud BaaS platform created by Scalezix Ventures LLP. It combines WhatsApp cart recovery, AI Voice COD confirmation calls, anonymous visitor identity resolution (Conversio Pass), and a full Postgres BaaS developer backend."
        }
      },
      {
        "@type": "Question",
        "name": "What makes Conversio AI unique for D2C brands and sales teams?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Conversio AI provides a unified platform that combines WhatsApp D2C retention, 3-step cart recovery, COD-to-prepaid conversion, tri-channel sales cadences (WhatsApp, Email, Voice), and sub-60-second speed-to-lead auto-dialing."
        }
      },
      {
        "@type": "Question",
