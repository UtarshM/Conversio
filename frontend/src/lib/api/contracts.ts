...
export const apiRoutes = {
  ...
  partnerCommissions: "/partners/commissions",
  ...
  partnerBranding: "/partners/branding",
  partnerVerifyDomain: "/partners/verify-domain",
  partnerSubWorkspaces: "/partners/sub-workspaces",
  brandingCurrent: "/branding/current",
} as const;
